...
class SearchSession(WorldcatSession):
    ...
    def _lookup_isbn_url(self, isbn):
        return "{}/content/isbn/{}".format(self.base_url, isbn)

    def _lookup_issn_url(self, issn):
        return "{}/content/issn/{}".format(self.base_url, issn)

    def _lookup_oclc_number_url(self, oclc_number):
        return "{}/content/{}".format(self.base_url, oclc_number)

    def _lookup_standard_number_url(self, std_number):
        return "{}/content/sn/{}".format(self.base_url, std_number)
    ...
    def _prepare_sort_keys(self, sort_keys):
        ...
        for key, order in sort_keys:
            mapped_sort.append("{}{}".format(KEY_MAP[key], ORD_MAP[order]))
    ...
    def _sru_query_url(self, query):
        return "{}/search/sru?query={}".format(self.base_url, query)
