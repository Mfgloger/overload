...
NW2SEXPORT_COLS = ['020|a~RECORD #(BIBLIO)~005~010|a~024|a~035|a~RECORD #(ORDER)~VEN NOTE(ORDER)~CODE2~CODE4~LOCATION~FORM~VENDOR~STATUS']
BW2SEXPORT_COLS = ['020|a~RECORD #~005~010|a~024|a~035|a~RECORD #~VEN NOTE~CODE2~OPAC DISPLAY~LOCATION~FORMAT~VENDOR~STATUS']
